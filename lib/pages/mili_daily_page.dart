...
import 'package:flutter_hub_test1/bucket_service.dart';
...
class MiliDailyPage extends StatefulWidget {
  const MiliDailyPage({Key? key}) : super(key: key);

  @override
  State<MiliDailyPage> createState() => _MiliDailyPageState();
}

class _MiliDailyPageState extends State<MiliDailyPage> {
      ...
      builder: (context, bucketService, child) {
        ...
        return Scaffold(
          body: bucketList.isEmpty
              ? Center(child: Text("미리 해야할 일을 적어주세요!"))
              : ListView.builder(
